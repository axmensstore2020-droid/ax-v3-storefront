...
function ServiceProviders() {
 return <section id="service-providers" className="policy-section">
  ...
  <p>AX Store uses trusted third-party service providers to operate the store, provide AX Stylist, process payments, manage customer accounts, host infrastructure, and support shipping and fulfilment. We share information with them only as needed for those services and subject to their applicable terms, privacy practices and our agreements with them.</p>
  <ul>
