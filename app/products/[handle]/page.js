...
export default async function ProductPage({params,searchParams}) {
 ...
 return <main id="main-content">
  ...
  <ProductPurchase key={product.id+':'+initialVariantId+':'+chooseSize} product={product} initialVariantId={initialVariantId} chooseSize={chooseSize} restockAlertsEnabled={restockAlertSignupConfigured()} colourways={[product]}/>
