...
export default function StylistInfoPage() {
  ...
  return <InfoPage eyebrow="AX STYLIST" title="A little direction. Your own style.">
    ...
    <ul>
      <li>When you agree and send a message, your message, recent chat context, relevant fit/profile details and any selected clothing photo are processed by OpenAI. AX product and policy data relevant to your request is also sent.</li>
      <li>AX does not save chat transcripts or photos to its database. Recent text and a short summary of older preferences are kept temporarily in this open chat in your browser, including a signed continuation token. Closing or clearing the chat removes that local chat state. Photos are used for the current reply only.</li>
