...
import {jsonLd,pageMetadata,storeJsonLd} from '../../lib/seo';

export const metadata=pageMetadata({
 title:'Men’s Clothing Stores in Coimbatore',
 description:'Visit AX Men’s Store in Coimbatore. Find our Sai Baba Colony and Thadagam Road stores, opening hours and directions.',
 path:'/stores'
});
