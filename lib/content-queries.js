...
const homepageCampaignFields=`id handle type fields { key value reference { __typename ... on MediaImage { image { url altText width height } } } }`;
export const homepageCampaignsQuery=`query AXHomepageCampaigns { metaobjects(type:"ax_homepage_campaign", first:50) { nodes { ${homepageCampaignFields} } } }`;
