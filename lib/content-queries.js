...
const homepageCampaignFields=`id handle type fields { key value reference { __typename ... on MediaImage { image { url altText width height } } ... on Video { sources { url mimeType format height width } previewImage { url altText width height } } ... on GenericFile { url mimeType } } }`;
