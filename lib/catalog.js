export const categories = [
  'New In', 'T-Shirts', 'Shirts', 'Trousers', 'Denim', 'Outerwear', 'Formal', 'Accessories'
];

export const collections = [
  { title: 'Linen Edit', subtitle: 'Breathe different', key: 'linen' },
  { title: 'Korean Fits', subtitle: 'Relaxed. Refined.', key: 'korean' },
  { title: 'Old School', subtitle: 'Timeless pieces', key: 'old-school' },
  { title: 'Formal', subtitle: 'Made for more', key: 'formal' }
];
