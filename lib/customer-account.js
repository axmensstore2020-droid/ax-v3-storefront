...
export function authCompleteUrl(config,returnTo='/account') { const url=new URL(safeReturnTo(returnTo),config.siteOrigin);url.searchParams.set('axAuth','complete');return url.toString(); }
