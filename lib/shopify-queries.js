...
export const productFields=`id handle title description productType vendor tags availableForSale featuredImage {url altText width height} priceRange {minVariantPrice {amount currencyCode}} selectedOrFirstAvailableVariant {sku} metafields(identifiers:[${AX_PRODUCT_IDENTIFIERS}]) {namespace key value}`;
