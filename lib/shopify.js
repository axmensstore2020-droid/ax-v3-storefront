...
import {productsQuery,homepageProductsQuery,collectionsQuery,collectionQuery,productQuery,productMetafieldsQuery,legacyProductMetafieldsQuery,merchantProductsQuery} from './shopify-queries.js';
...
export const getProduct=cache(async handle => {
 const [coreResult,metaResult]=await Promise.allSettled([
