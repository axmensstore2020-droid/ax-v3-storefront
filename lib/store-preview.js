...
export function storePreviewKeyValid(value,expectedHash=STORE_PREVIEW_KEY_SHA256){
  if(typeof value!=='string'||value.length<20||value.length>160||!/^[a-f0-9]{64}$/i.test(String(expectedHash)))return false;
