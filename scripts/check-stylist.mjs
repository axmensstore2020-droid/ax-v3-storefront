...
console.log('Advanced model: '+config.advancedModel+'; enabled: '+config.advancedEnabled+'; daily turn cap: '+config.advancedDailyLimit);
if(process.env.OPENAI_STYLIST_MODEL) console.log('REMOVE legacy OPENAI_STYLIST_MODEL; use OPENAI_DEFAULT_MODEL / OPENAI_ADVANCED_MODEL.');
